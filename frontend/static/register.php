...
<body>
    ...
    <main class="min-vh-100 d-flex align-items-center justify-content-center">
        <div class="container bg-white d-flex p-0 shadow-lg rounded-3"
            style="max-width: 900px; border: 1px solid #4D194D;">
    
            <div class="p-5" style="flex: 1;">
                <h3 class="text-center mr-4">Create account</h3>
                <form action="../../backend/controllers/register.php" method="POST">
                    ...
                    <div class="mb-3 input-icon">
                        ...
                        <i class="fa-solid fa-user-pen single-icon"></i>
                        <input 
                        type="text" 
                        name="name" 
                        class="form-control icons"
                    ...
                    <div class="mb-3 input-icon">
                        ...
                        <i class="fa-solid fa-envelope single-icon"></i>
                        <input 
                            type="email" 
                            name="email" 
                            class="form-control icons"
                    ...
                    <div class="mb-3 input-icon">
                        ...
                        <i class="fa-solid fa-lock single-icon"></i>
                        <input 
                        type="password" 
                        name="password" 
                        class="form-control icons"
