...
<body>
    ...
    <!-- Página principal -->
    <main class="d-flex align-items-center justify-content-center font-family-login">
            ...
            <div class="row g-0 align-items-center rounded-3 shadow w-100 border-custom-login">
                ...
                <div class="col-md-6 d-flex p-5">
                    <div class="w-100 d-flex flex-column justify-content-center">
                        ...
                        <form class="font-size-login" action="../../backend/controllers/login.php" method="POST">
